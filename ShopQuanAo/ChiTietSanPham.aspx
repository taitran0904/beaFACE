    ...
    <div id="ct_content">
        ...
        <div id="ct_right_content">
            ...
            <div id="add_product">
                ...
                <br />
                <%--<asp:Button ID="ibtnMua" runat="server" />--%>
                <%--<asp:Button ID="btnMua" runat="server" Text="Thêm vào giỏ" class="btn btn-dark btn-sm"/>--%>
                <asp:LinkButton ID="lbtnMua" runat="server" class="btn btn-dark btn-sm">Thêm vào giỏ&ensp;<i class="fa fa-cart-plus"></i></asp:LinkButton>
            </div>
