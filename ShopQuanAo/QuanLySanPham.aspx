             ...
             <tr>
                ...
                <td class="style6">
                 ...
                 <td>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                         ...
                         ValidationGroup="CapNhat" ForeColor="Red"></asp:RequiredFieldValidator><br />
                     <asp:Label ID="lblMaSP1" runat="server" ForeColor="#CC0000"></asp:Label>
                 </td>
                 <td>
                ...
                <td>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ...
                         ValidationGroup="CapNhat" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
